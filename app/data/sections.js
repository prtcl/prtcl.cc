...
module.exports = [
  ...
  },
  {
    ...
    items: [
      {
        title: 'iching.io',
        description: 'Experimental method of consulting the I Ching',
        link: 'http://iching.io/'
      },
      {
        title: 'Supermoon',
        description: 'Visualizing real-time VLF radio data',
        link: 'http://supermoon.prtcl.cc/'
      },
      {
        title: 'TiberSynth',
        description: 'Real-time audio synthesis and many-to-many vector mapping in the web browser',
        link: 'http://tibersynth.prtcl.cc/'
      },
      {
        title: 'Birds',
        description: 'A/V web installation for Chrome. Video and real-time audio synthesis',
        link: 'http://birds.prtcl.cc/'
      },
      {
        title: 'Ternary Bop',
